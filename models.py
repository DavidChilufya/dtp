...
class InterviewsMetaData(models.Model):
    user_id = models.CharField(max_length=40)
    interview_id = models.CharField(max_length=11)
    first_interview = models.CharField(max_length=20)
    coop_union = models.CharField(max_length=45)
    prime_coop = models.CharField(max_length=16)
    latitude = models.CharField(max_length=16)
    longitude = models.CharField(max_length=40)
    current_section = models.CharField(max_length=8)
    field_time = models.CharField(db_column='_time', max_length=8)  # Field renamed because it started with '_'.
    field_date = models.CharField(db_column='_date', max_length=35)  # Field renamed because it started with '_'.

    class Meta:
        managed = False
        db_table = 'interviews_meta_data'
